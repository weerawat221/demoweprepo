...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Home Code" },
    { name: "description", content: "Source code for the Dashboard page." },
  ];
}

// --- 👇 โค้ดใหม่ทั้งหมดถูกนำมาใส่ในตัวแปรนี้ ---
const homeCode = `
import React from 'react';
import { motion } from 'framer-motion';
import Nav from '~/components/Nav';
    ...
    <div className="min-h-screen bg-gray-900 text-white p-8 font-sans">
      ...
      <div className="container mx-auto max-w-4xl pt-20">
        ...
        <p className="text-center text-gray-400 mb-10 text-lg">
          โค้ดสำหรับสร้างหน้า Dashboard
          ที่แสดงภาพรวมของเทคโนโลยีที่ใช้ในโปรเจกต์
        </p>
        <motion.div
        ...
        >
          <h2 className="text-2xl font-bold mb-4 text-white">
            โครงสร้างและ Component
          </h2>
          <p className="text-gray-400 mb-4">
            ไฟล์นี้ประกอบด้วยการตั้งค่าเมตา, คอมโพเนนต์ไอคอน SVG,
            และส่วนแสดงผลที่ใช้{" "}
            <code className="text-sm font-mono text-yellow-300 bg-yellow-400/10 px-1 py-0.5 rounded">
              framer-motion
            </code>{" "}
            เพื่อสร้างการ์ดที่มีแอนิเมชันสวยงาม
          </p>
          <CodeBlock code={homeCode.trim()} language="tsx" />
        </motion.div>
      </div>
      <Footer />
    </div>
