import{w as e,p as t}from"./chunk-PVWAREVJ-BKTQPsXo.js";import{N as o,m as a}from"./Nav-CpNU6Ajp.js";import{C as s}from"./CodeBlock-BN9FJjQ-.js";import{F as l}from"./Footer-DS8jGZNM.js";function h({}){return[{title:"Home Code"},{name:"description",content:"Source code for the Dashboard page."}]}const c=`
...
`,m=e(function(){return t.jsxs("div",{className:"min-h-screen bg-gray-900 text-white p-8 font-sans",children:[t.jsx(o,{}),t.jsxs("div",{className:"container mx-auto max-w-4xl pt-20",children:[t.jsx("h1",{className:"text-4xl md:text-5xl font-extrabold text-center mb-12 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-transparent bg-clip-text",children:"Home Dashboard"}),t.jsx("p",{className:"text-center text-gray-400 mb-10 text-lg",children:"โค้ดสำหรับสร้างหน้า Dashboard ที่แสดงภาพรวมของเทคโนโลยีที่ใช้ในโปรเจกต์"}),t.jsxs(a.div,{className:"p-6 rounded-xl border-t-4 border-b-4 border-purple-500",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.5},children:[t.jsx("h2",{className:"text-2xl font-bold mb-4 text-white",children:"โครงสร้างและ Component"}),t.jsxs("p",{className:"text-gray-400 mb-4",children:["ไฟล์นี้ประกอบด้วยการตั้งค่าเมตา, คอมโพเนนต์ไอคอน SVG, และส่วนแสดงผลที่ใช้"," ",t.jsx("code",{className:"text-sm font-mono text-yellow-300 bg-yellow-400/10 px-1 py-0.5 rounded",children:"framer-motion"})," ","เพื่อสร้างการ์ดที่มีแอนิเมชันสวยงาม"]}),t.jsx(s,{code:c.trim(),language:"tsx"})]})]}),t.jsx(l,{})]})});export{m as default,h as meta};
