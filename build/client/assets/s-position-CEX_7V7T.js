import{w as t,p as e}from"./chunk-PVWAREVJ-BKTQPsXo.js";import{N as s,m as o}from"./Nav-CpNU6Ajp.js";import{C as i}from"./CodeBlock-BN9FJjQ-.js";import{F as n}from"./Footer-DS8jGZNM.js";function p({}){return[{title:"Code: PositionPage"},{name:"description",content:"Complete source code for PositionPage.tsx"}]}const a=`
// Position.tsx
...
`,u=t(function(){return e.jsxs("div",{className:"min-h-screen bg-gray-900 text-white p-8 font-sans",children:[e.jsx(s,{}),e.jsxs("div",{className:"container mx-auto max-w-4xl pt-20",children:[e.jsx("h1",{className:"text-4xl md:text-5xl font-extrabold text-center mb-12 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-transparent bg-clip-text",children:"Position.tsx"}),e.jsx("p",{className:"text-center text-gray-400 mb-10 text-lg",children:"ไฟล์ Component หลักสำหรับหน้าจัดการข้อมูลตำแหน่ง (Position Management) ซึ่งเป็นหน้า CRUD (Create, Read, Update, Delete) พื้นฐาน"}),e.jsxs(o.div,{className:"p-6 rounded-xl border-t-4 border-b-4 border-purple-500",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.5},children:[e.jsx("h2",{className:"text-2xl font-bold mb-4 text-white",children:"ฟีเจอร์และส่วนประกอบหลัก"}),e.jsxs("p",{className:"text-gray-400 mb-4",children:["โค้ดนี้แสดงการจัดการข้อมูลในรูปแบบตาราง (Table) โดยใช้"," ",e.jsx("code",{className:"text-sm font-mono text-pink-400",children:"framer-motion"})," ","เพื่อเพิ่ม animation ทำให้แถวในตารางทยอยปรากฏขึ้นอย่างสวยงาม"]}),e.jsxs("ul",{className:"text-gray-400 mb-6 space-y-2 list-disc list-inside",children:[e.jsxs("li",{children:[e.jsx("strong",{className:"text-white",children:"Animated Table:"})," ใช้"," ",e.jsx("code",{className:"text-sm font-mono text-yellow-300",children:"staggerChildren"})," ","เพื่อให้แถวข้อมูล (rows) ในตารางทยอยแสดงผล"]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-white",children:"Glassmorphism Modals:"})," ",'หน้าต่าง Popup สำหรับสร้าง, แก้ไข, และลบข้อมูล มีลักษณะโปร่งใสและมี animation ที่ "เด้ง" ตอบสนองต่อผู้ใช้']}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-white",children:"Bouncy Buttons:"})," ","ปุ่มทั้งหมดในหน้านี้ ทั้งปุ่มหลักและปุ่ม Action ในตาราง มีการตอบสนองที่สนุกสนานเมื่อใช้งาน"]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-white",children:"Dynamic Notifications:"})," Popup แจ้งเตือนจะแสดงข้อความที่เฉพาะเจาะจงตาม Action ที่ทำสำเร็จ เช่น บอกชื่อตำแหน่งที่เพิ่งสร้างหรือลบไป"]})]}),e.jsx(i,{code:a,language:"tsx"})]}),e.jsx(n,{})]})]})});export{u as default,p as meta};
