import{w as t,p as e}from"./chunk-PVWAREVJ-BKTQPsXo.js";import{N as a,m as s}from"./Nav-CpNU6Ajp.js";import{C as o}from"./CodeBlock-BN9FJjQ-.js";import{F as r}from"./Footer-DS8jGZNM.js";function h({}){return[{title:"Code: TeacherPage"},{name:"description",content:"Complete source code for TeacherPage.tsx"}]}const n=`
// Teacher.tsx
...
`,u=t(function(){return e.jsxs("div",{className:"min-h-screen bg-gray-900 text-white p-8 font-sans",children:[e.jsx(a,{}),e.jsxs("div",{className:"container mx-auto max-w-4xl pt-20",children:[e.jsx("h1",{className:"text-4xl md:text-5xl font-extrabold text-center mb-12 bg-gradient-to-r from-teal-400 via-cyan-500 to-sky-600 text-transparent bg-clip-text",children:"Teacher.tsx"}),e.jsx("p",{className:"text-center text-gray-400 mb-10 text-lg",children:"ไฟล์ Component หลักสำหรับหน้าจัดการข้อมูลบุคลากร (Teacher Management)"}),e.jsxs(s.div,{className:"p-6 rounded-xl border-t-4 border-b-4 border-cyan-500",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.5},children:[e.jsx("h2",{className:"text-2xl font-bold mb-4 text-white",children:"ฟีเจอร์และส่วนประกอบหลัก"}),e.jsxs("p",{className:"text-gray-400 mb-4",children:["โค้ดนี้จัดการทุกอย่างตั้งแต่การดึงข้อมูลจาก API, การแสดงผล, ไปจนถึงการสร้าง, แก้ไข, และลบข้อมูล โดยใช้"," ",e.jsx("code",{className:"text-sm font-mono text-pink-400",children:"framer-motion"})," ","เพื่อเพิ่ม animation ให้กับ UI"]}),e.jsxs("ul",{className:"text-gray-400 mb-6 space-y-2 list-disc list-inside",children:[e.jsxs("li",{children:[e.jsx("strong",{className:"text-white",children:"State Management:"})," ใช้"," ",e.jsx("code",{className:"text-sm font-mono text-yellow-300",children:"useState"})," ","และ"," ",e.jsx("code",{className:"text-sm font-mono text-yellow-300",children:"useEffect"})," ","ในการจัดการข้อมูลและสถานะต่างๆ ของหน้า"]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-white",children:"CRUD Operations:"})," ","ฟังก์ชันสำหรับ"," ",e.jsx("code",{className:"text-sm font-mono text-pink-400",children:"Create"}),","," ",e.jsx("code",{className:"text-sm font-mono text-pink-400",children:"Read"}),","," ",e.jsx("code",{className:"text-sm font-mono text-pink-400",children:"Update"}),", และ"," ",e.jsx("code",{className:"text-sm font-mono text-pink-400",children:"Delete"})," ","ข้อมูลผ่าน API"]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-white",children:"Animated UI:"})," แสดงผลข้อมูลในรูปแบบการ์ดที่ Animate ทยอยขึ้นมา และมี Modal แบบโปร่งใส (Glassmorphism) ที่เคลื่อนไหวอย่างสวยงาม"]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-white",children:"Custom Components:"})," ","เรียกใช้งาน"," ",e.jsx("code",{className:"text-sm font-mono text-yellow-300",children:"CustomSelect"})," ","เพื่อประสบการณ์ใช้งานที่ดีกว่า Select box แบบเดิม"]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-white",children:"User Feedback:"})," มี Popup แจ้งเตือน (Notification) ที่เลื่อนลงมาจากด้านบนเพื่อแจ้งผลการทำงานต่างๆ"]})]}),e.jsx(o,{code:n,language:"tsx"})]}),e.jsx(r,{})]})]})});export{u as default,h as meta};
